...
namespace ECommerceAPI.Persistence.Migrations
{
    ...
    [Migration("20230821131625_mig-6")]
    partial class mig6
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProductProductImageFile", b =>
                {
                    ...
                    b.Property<Guid>("ProductsImageFilesId")
                        .HasColumnType("uuid");

                    b.HasKey("ProductsId", "ProductsImageFilesId");

                    b.HasIndex("ProductsImageFilesId");
            ...
            modelBuilder.Entity("ProductProductImageFile", b =>
                {
                    ...
                    b.HasOne("ECommerceAPI.Domain.Entities.ProductImageFile", null)
                        .WithMany()
                        .HasForeignKey("ProductsImageFilesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
